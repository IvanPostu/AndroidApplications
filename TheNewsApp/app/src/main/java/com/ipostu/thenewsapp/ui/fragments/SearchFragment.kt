...
import com.ipostu.thenewsapp.databinding.FragmentSearchBinding
...
import com.ipostu.thenewsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        retryButton.setOnClickListener() {
            if (binding.searchEdit.text.toString().isNotBlank()) {
